...
<!-- 
Transform to alter the output from heat.exe for Test
Main functions:
-Remove the "Test.exe", if it is contained in PackageFiles.wxs
...
<xsl:stylesheet version="1.0"
	...
	<xsl:key name="exe-search" match="wix:Component[contains(wix:File/@Id, 'Test.exe')]" use="@Id" />
