Adoptium Open JRE x64 11.0.100 ML (Multi-Language)
...
msiexec /i "Adoptium_JRE_Hotspot_64_11.0.100_ML.msi" ALLUSERS=1 ADDLOCAL=ALL

Slient Install: msiexec /i "Adoptium_JRE_Hotspot_64_11.0.100_ML.msi" /qn (absolute silent) or /qb! (with progress-dialog).
