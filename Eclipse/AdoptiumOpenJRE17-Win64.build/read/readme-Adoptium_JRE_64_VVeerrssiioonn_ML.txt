Adoptium Open JRE x64 1.0.1 ML (Multi-Language)
...
msiexec /i "Adoptium_JRE_Hotspot_64_1.0.1_ML.msi" ALLUSERS=1 ADDLOCAL=ALL

Slient Install: msiexec /i "Adoptium_JRE_Hotspot_64_1.0.1_ML.msi" /qn (absolute silent) or /qb! (with progress-dialog).
