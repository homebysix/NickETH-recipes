Adoptium Open JRE x86 11.0.100.1 ML (Multi-Language)
...
msiexec /i "Adoptium_JRE_Hotspot_11.0.100.0_ML.msi" ALLUSERS=1 ADDLOCAL=ALL

Slient Install: msiexec /i "Adoptium_JRE_Hotspot_11.0.100.0_ML.msi" /qn (absolute silent) or /qb! (with progress-dialog).
