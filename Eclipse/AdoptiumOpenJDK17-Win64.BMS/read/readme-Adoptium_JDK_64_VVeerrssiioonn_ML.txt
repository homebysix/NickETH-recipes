...
msiexec /i "Adoptium_JDK_Hotspot_64_11.0.100_ML.msi" ALLUSERS=1 ADDLOCAL=ALL

Slient Install: msiexec /i "Adoptium_JDK_Hotspot_64_11.0.100_ML.msi" /qn (absolute silent) or /qb! (with progress-dialog).
