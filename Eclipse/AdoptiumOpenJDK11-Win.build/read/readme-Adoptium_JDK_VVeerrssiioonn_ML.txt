Adoptium Open JDK x86 8.0.100.0 ML (Multi-Language)
...
msiexec /i "Adoptium_JDK_Hotspot_8.0.100.0_ML.msi" ALLUSERS=1 ADDLOCAL=ALL

Slient Install: msiexec /i "Adoptium_JDK_Hotspot_8.0.100.0_ML.msi" /qn (absolute silent) or /qb! (with progress-dialog).
