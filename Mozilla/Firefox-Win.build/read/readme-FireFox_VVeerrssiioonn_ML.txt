Mozilla Firefox 66.0.2 ML (Multi-Language)
...
Optionen: - DEFAULTPREFS=0   --> Default-Prefs können ausgeschaltet werden. Siehe auch create-log.
	  ...
	  - QUICKLAUNCH_SC=0 --> Shortcuts in der QuickLaunch-Toolbar können ausgeschaltet werden.
...
Slient Install: msiexec /i "FireFox_66.0.2_ML.msi" /qn (komplett silent) oder /qb! (mit Fortschritts-Dialog).
