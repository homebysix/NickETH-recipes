...
findstr /R upgradeversion=\"[0-9][0-9]\.[0-9]\.[0-9]\" ..\wixproject\version.wxi > upverline.txt
set /p UPGRADEVERSIONLINE=<upverline.txt
set filever=%UPGRADEVERSIONLINE:~27,-3%
del /f /q upverline.txt
...
copy ..\read\create-log*.txt %DESTPATH%\
copy ..\read\readme-*.txt %DESTPATH%\
FOR %%G IN (%ReleaseFilesSet%) DO copy ..\release\%%G %DESTPATH%\%%G
