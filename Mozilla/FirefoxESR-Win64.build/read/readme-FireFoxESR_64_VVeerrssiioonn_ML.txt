Mozilla Firefox ESR 135.0.0 ML (Multi-Language)
...
Mozilla Release Notes for FF 135.0.0: https://www.mozilla.org/en-US/firefox/135.0/releasenotes/

Start the installation with the following command line:
msiexec /i "FireFoxESR_66.0.2_ML.exe" /DesktopShortcut=false /TaskbarShortcut=false /MaintenanceService=false
