...
PLATS = ["Windows", "Windows64", "MacOSX", "Linux64", "All", "Eclipse"]
...
class OxygenURLProvider(URLGetter):
    ...
    def main(self):
        ...
        if plat == "Eclipse":
            ...
            if plat == "Windows":
                download_url = (
                    "https://mirror.oxygenxml.com/InstData/WebAuthor/Windows/oxygenxml-web-author-64bit.exe"
                )
            else:
                download_url = (
                    "https://mirror.oxygenxml.com/InstData/WebAuthor/All/oxygenxml-web-author-all-platforms.zip"
                    % (prod, plat)
                )
        elif prod == "WebHelp":
            download_url = (
            ...
            if plat == "Windows64":
                ...
                download_url = (
                    "https://mirror.oxygenxml.com/InstData/%s/%s/VM/oxygen%s.tar.gz"
                    % (prod, plat, prod)
                )
